...
import { MapPin, Filter, Search, Grid, List, Sliders, ArrowUpDown, Heart } from 'lucide-react';
            ...
            <>
              {filteredDestinations.length === 0 ? (
                <motion.div 
                  ...
                  transition={{ duration: 0.5 }}
                  className="text-center py-16 bg-white dark:bg-blue-900/30 rounded-xl shadow-md border border-blue-100 dark:border-blue-800"
                >
                ...
                >
                  {filteredDestinations.map((destination, index) => (
                    ...
                    >
                      <Card 
                        className={`overflow-hidden border-blue-100 dark:border-blue-800 bg-white dark:bg-blue-900/20 shadow-sm hover:shadow-md transition-all duration-300 ${
