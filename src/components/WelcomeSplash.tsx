        ...
        >
          ...
          >
            ...
            >
              <div className="w-24 h-24 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center">
                <motion.div 
                  ...
                  className="w-16 h-16 rounded-full bg-gradient-to-br from-yellow-400 to-orange-600 flex items-center justify-center"
                >
            ...
            <motion.div variants={itemVariants} className="w-full max-w-md mx-auto">
              <Progress 
                value={progress} 
                className="h-2 bg-white/10 overflow-hidden rounded-full before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-r before:from-yellow-300 before:to-orange-500" 
              />
